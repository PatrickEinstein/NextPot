        ...
        <div className="col-span-7 place-self-center text-center sm:text-left justify-self-start w-full ">
          ...
          <div>
            ...
            <button className="px-1 py-1 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 text-white mt-3">
              <a
                // href="https://res.cloudinary.com/dsdkmnf0b/image/upload/f_auto,q_auto/smojhnufehofsw2ekcuk"
                href="https://drive.google.com/file/d/1hBc7CUxzl2YMUC07G6li_ZGZGHZJFMOM/view" target="blank"
                download="MohammedOlalekanPatrick.pdf"
              >
