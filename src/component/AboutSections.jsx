      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full" id="about">
          ...
          <p className="text-color lg:text-lg">
            ...
            <br />
            <em>Service Oriented Architecture</em>
            <br />
            <em>Micro-service Architecture</em>
            <br />
            <em>Docker and Kubernetes</em>
            <br />
            <em>C#,</em>
            <br />
            <em>DOTNET</em>
            ...
            <br />
            <br />
            <br />I am a Fullstack web developer and a Software Architect with 5+ years in building
